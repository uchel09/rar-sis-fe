...
function DashboardAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const selectedKeys = useMemo(() => {
    ...
    if (pathname.includes("/dashboard/student")) {
      ...
      if (pathname.includes("/extracuriculler")) return ["2-3"];
      if (pathname.includes("/rapor")) return ["2-2"];
      if (pathname.includes("/attendance")) return ["2-4"];
  ...
  const sidebarItems = [
    {
      ...
      label: <Link href="/dashboard/student">Dashboard</Link>,
    },
    {
      key: "2",
      icon: <BookOutlined />,
      ...
      children: [
        {
          ...
          icon: <TeamOutlined />,
          label: (
            <Link href={`/dashboard/student/extracuriculler`}>
              Extracuriculler
            </Link>
          ),
        },
        {
          key: "2-2",
          icon: <UserOutlined />,
          label: <Link href="/dashboard/student/rapor">Rapor</Link>,
        },
        {
          key: "2-4",
          icon: <BookOutlined />,
          label: (
            <Link href="/dashboard/student/attendance">Kehadiran</Link>
          ),
        },
        {
          key: "2-1",
          icon: <BookOutlined />,
          label: (
            <Link href="/dashboard/student/schedule">Jadwal Mapel</Link>
          ),
        },
      ],
    },
